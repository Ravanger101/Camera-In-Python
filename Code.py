...
"""
Demo program that displays a webcam 
"""
...
def main():
    ...
    layout = [[sg.Text('Demo Camer Made by Aryan Gore', size=(40, 1), justification='center', font='Helvetica 20')],
    ...
    window = sg.Window('Demo Camera Made By Aryan',
